...
6. Sign in and Register. Satisfies **AC-8**. (Not started. Placeholder pages exist.)
7. Manage Profile, following `docs/uc14-ui-ux-brief.md`. Satisfies **AC-10**, **AC-11**, **AC-12**, **AC-13**. (Not started. Placeholder page exists.)
8. Tests: accessibility assertions on the primitives, the server error mapping, and the guard redirect. Satisfies **AC-6**, **AC-11**, **AC-12**, **AC-15**. (Seeded: a Button axe smoke test proves the harness. Full coverage still owed.)
